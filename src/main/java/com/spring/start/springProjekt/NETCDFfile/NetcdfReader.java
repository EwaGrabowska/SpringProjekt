...
public class NetcdfReader {
    ...
    public static ArgoFile setArgoFileAtribute(MultipartFile multipart) throws IOException {
        ...
        try {
            ...
            argoFile.setFeatureType(featureType);
            argoFile.setCreationDate(creationDate);
            argoFile.setPlatformNumber(platformNumber);
            argoFile.setProjectName(projectName);
            argoFile.setNameOfPrincipalInvestigator(nameOfPrincipalInvestigator);
    ...
    public static String readTitle(MultipartFile multipart) throws IOException {
        File file = multipartToFile(multipart);
        Netcdf nc = null;
        String title = "";
        try {
